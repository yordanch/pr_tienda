...
<nav class="navbar navbar-expand justify-content-between fixed-top">
    <a class="navbar-brand mb-0 h1 d-none d-md-block" href="">
        <img src="<?=$path;?>demo/img/logo.png" class="navbar-brand-image d-inline-block align-top mr-2" alt="" />
        Panel de control
    </a>
    ...
    <form class="form-inline form-quicksearch d-none d-md-block mx-auto">
        <div class="input-group">
            ...
            <input type="text" class="form-control" id="search" placeholder="Ingrese para buscar ..." />
        </div>
    </form>
    ...
    <ul class="navbar-nav d-flex justify-content-end mr-2">
        ...
        <li class="nav-item dropdown d-flex align-items-center mr-2">
            ...
            <div class="dropdown-menu dropdown-menu-right dropdown-menu-notifications" aria-labelledby="dropdownNotifications">
                <div class="notifications-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="#" class="d-flex"><small>Leer todo</small></a>
                </div>
                ...
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-action unread">
                        <p class="mb-1">
                            ...
                            <strong>Jan 12th 2018</strong> by
                            <strong>Laura</strong>
                        </p>
                    ...
                    <a href="#" class="list-group-item list-group-item-action">
                        <p class="mb-1">
                            Your task
                            <strong>Design Draft</strong> is due
                            today.
                        </p>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link avatar-with-name" id="navbarDropdownMenuLink" data-toggle="dropdown" href="#">
                <img src="<?=$path;?>../img/System/avatar.jpg" class="d-inline-block align-top" alt="">
            </a>
